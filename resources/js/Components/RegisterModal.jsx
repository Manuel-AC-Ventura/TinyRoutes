      ...
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          ...
          >
            ...
            <div className="mt-8">
              <input value={name} onChange={(e) => setName(e.target.value)} className="text-black border-2 border-gray-300 rounded-md p-2 w-full focus:outline-none" type="text" autoComplete="current-email" placeholder="Nome" />
            </div>
            <div className="mt-4">
              <input value={email} onChange={(e) => setEmail(e.target.value)} className="text-black border-2 border-gray-300 rounded-md p-2 w-full focus:outline-none" type="text" autoComplete="current-email" placeholder="Email" />
            </div>
            <div className="mt-4">
            ...
            <button type="submit" className="mt-8 bg-blue-500 text-white rounded-md px-4 py-2 w-full">Cadastrar</button>
          </motion.form>
        </div>
      )}
    </AnimatePresence>
